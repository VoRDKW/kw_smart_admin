            ...
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse<?=$BuildingID?>" aria-expanded="false" aria-controls="collapse<?=$BuildingID?>">
                            อาคาร&nbsp;<?= $building['BuildingNo'] . ' ' . $building['BuildingName'] ?></a>
                    </h3>
                </div>
                <div id="collapse<?=$BuildingID?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
